                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-calendar"></i>Horarios<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="tables_dynamic.html">Generar</a></li>
                                            <li><a href="horarios.html">Tablas de creación</a></li>
                            ...
                            <ul class=" navbar-right">
                                <li class="nav-item dropdown open" style="padding-left: 15px;">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                                        <img src="images/SENA Horarios.jpg" alt="">Eddie Merck Camacho
                                    </a>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Ilustración</div> 
                                                    ...
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Multimedia</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Fotografía</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Audiovisuales</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Computación</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Serigrafía</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                    ...
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Impresión 3D</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                    <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                                                        <div class="tile-stats">
                                                            <div class="icon"></div>
                                                            <div class="count">Encuadernación</div> 
                                                            <a href=""><p>Competencias y resultados</p></a>
                                                        </div>
                                                    </div>
                                                </div>
